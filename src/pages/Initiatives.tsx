...
const keyInitiatives = [
  {
    ...
    summary: "Collaborative frameworks for locally relevant, globally competitive energy transition plans",
  ...
  },
  {
    ...
    summary: "Hands-on technical and operational support from planning to measurable results",
  ...
  },
  {
    ...
    summary: "Evidence-based recommendations on energy policy, carbon management, and ESG compliance",
  ...
  },
  {
    ...
    summary: "Neutral platform fostering dialogue and joint initiatives across sectors",
  ...
  },
  {
    ...
    summary: "Landing platform for clean energy innovations to access the Nigerian market",
  ...
  },
  {
    ...
    summary: "Mobilizing capital for renewable energy projects across Africa",
  ...
  },
  {
    ...
    summary: "Capacity building and leadership development for sustainability professionals",
            ...
            {keyInitiatives.map((initiative: any, index: number) => {
              ...
              return (
                <AccordionItem 
                  ...
                  value={`item-${index}`}
                  className="border border-border rounded-lg px-6 shadow-soft hover:shadow-medium transition-all duration-300 animate-fade-in"
                  style={{ animationDelay: `${index * 100}ms` }}
                >
                  <AccordionTrigger className="hover:no-underline py-6">
                    <div className="flex items-center gap-4 text-left flex-1">
                      <div className={`w-12 h-12 ${initiative.bgColor} rounded-xl flex items-center justify-center flex-shrink-0`}>
