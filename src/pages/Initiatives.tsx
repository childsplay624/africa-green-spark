...
const keyInitiatives = [
  ...
  },
  {
    ...
    description:
      "AE&SC serves as a trusted advisor to governments, corporations, and development agencies on pressing issues such as energy transition policy, carbon management, renewable integration, and ESG compliance. The consortium leverages deep sector expertise and data insights to shape evidence-based recommendations, enabling stakeholders to make informed decisions that balance energy security, sustainability, and economic growth.",
    color: "text-accent",
  ...
  },
  {
    ...
    description:
      "AE&SC offers a landing platform for clean and emerging energy technologies such as green hydrogen, smart grids, carbon capture, and digital energy management tools to gain access to the Nigerian and wider African market. The consortium creates pathways for technology validation, regulatory alignment, and pilot deployment, serving as a bridge between innovators and local stakeholders to ensure successful adoption and scale-up.",
    color: "text-primary",
    bgColor: "bg-primary/10",
  },
  {
  ...
  },
  {
    ...
    description:
      "AE&SC believes people are the engine of Africa's sustainability transition. The consortium invests in capacity building, leadership development, and technical training to empower energy professionals, policymakers, and community leaders. Through targeted programs, AE&SC nurtures a generation of skilled, sustainability-minded changemakers capable of leading the continent's transition toward cleaner, inclusive, and resilient energy systems.",
    color: "text-accent",
    bgColor: "bg-accent/10",
  },
];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(19, 50, 44, 0.8), rgba(19, 50, 44, 0.8)), url(${initiativesHero})`,
        }}
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <p className="text-xl leading-relaxed animate-fade-in delay-200">
            {heroData?.subtitle ||
              ...
              "Strategic programs driving Africa's energy transition through innovation, collaboration, and sustainable development."}
          </p>
        </div>
      </section>
            ...
            {keyInitiatives.map((initiative: any, index: number) => {
              ...
              return (
                ...
                >
                  <CardHeader>
                    <div
                      className={`w-16 h-16 ${initiative.bgColor} rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                    >
                      <Icon className={`h-8 w-8 ${initiative.color}`} />
                    </div>
                    <CardTitle className="text-2xl font-heading font-bold">{initiative.title}</CardTitle>
                    <CardDescription className="text-lg leading-relaxed">{initiative.description}</CardDescription>
                  </CardHeader>
                </Card>
              );
            })}
      ...
      <section className="py-20 bg-muted/50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-heading font-bold text-foreground mb-4">Implementation Focus</h2>
            <p className="text-xl text-muted-foreground">Where we're making the biggest impact across Africa</p>
          </div>
            ...
            {(pageContent?.focusAreas || focusAreas).map((area: any, index: number) => (
              ...
              >
                <CardContent className="p-6">
                  <h3 className="font-heading font-semibold text-lg mb-3">{area.title}</h3>
                  <p className="text-muted-foreground text-sm mb-4 leading-relaxed">{area.description}</p>
                  <div className="space-y-2">
                    <div className="text-sm font-medium text-primary">{area.projects}</div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-heading font-bold text-foreground mb-8">Measurable Impact</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12">
            {(
              ...
              <div key={idx} className="text-center">
                <div
                  className={`text-4xl font-heading font-bold mb-2 ${idx === 0 ? "text-primary" : idx === 1 ? "text-secondary" : "text-accent"}`}
                >
                  {stat.value}
                </div>
          ...
          <div className="bg-gradient-primary rounded-2xl p-8 text-white">
            <h3 className="text-2xl font-heading font-bold mb-4">Partner With Our Initiatives</h3>
            <p className="text-lg leading-relaxed mb-6 text-white/90">
              Join us in driving Africa's energy transition. Together, we can create lasting impact across the
              continent.
            </p>
